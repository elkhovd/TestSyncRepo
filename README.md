...
В данном разделе содержаться примеры разработки скриптов и собственных элементов управления для использования в карточках Docsvision Web-клиент 8.1 и выше, настроенных с использованием Конструктора Web-разметок.
...
### Структура разделов
 ...
 3. **ControlProperties/Url** - Пример разработки собственный свойств для Конструктора разметок
